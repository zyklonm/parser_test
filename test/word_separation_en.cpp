...
//temp_code_end
	...
	case WORD_LENGTH_ONE:
	{
		fp.open("en_wiki_word_list_one.txt");
		break;
	}
	case WORD_LENGTH_TWO:
        {
                fp.open("en_wiki_word_list_tow.txt");
                break;
        }
	case WORD_LENGTH_THREE:
        {
                fp.open("en_wiki_word_list_three.txt");
                break;
        }
	case WORD_LENGTH_FOUR:
        {
                fp.open("en_wiki_word_list_four.txt");
                break;
        }
	case WORD_LENGTH_FIVE:
        {
                fp.open("en_wiki_word_list_five.txt");
                break;
        }
    }
    int i = 0;
