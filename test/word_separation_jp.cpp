...
#define SEPARATION_WORD_NUM 200000000
...
//temp_code_end
	...
	case WORD_LENGTH_ONE:
	{
		fp.open("jp_wiki_word_list_one.txt");
		break;
	}
	case WORD_LENGTH_TWO:
	{
		fp.open("jp_wiki_word_list_two.txt");
		break;
	}
	case WORD_LENGTH_THREE:
	{
		fp.open("jp_wiki_word_list_three.txt");
		break;
	}
	case WORD_LENGTH_FOUR:
	{
		fp.open("jp_wiki_word_list_four.txt");
		break;
	}
	case WORD_LENGTH_FIVE:
	{
		fp.open("jp_wiki_word_list_five.txt");
		break;
	}
    }
    int i = 0;
...
//	cout<<word[i]<<"  :  "<<*(word_same_num+i)<<endl;
	fp<<word[i]<<"  :  "<<*(word_same_num+i)<<endl;
    }
    end = clock();
